...
% Plot data...
figure(); 
XMASS_tish(256-Registered(:,:,1,1),256-Registered(:,:,1,2),256-Registered(:,:,1,1),'hl',[0.1 0.95]);
title('aligned, adjacent slides');
figure(); 
XMASS_tish(256-ResizedIM(:,:,1,1),256-ResizedIM(:,:,1,2),256-ResizedIM(:,:,1,1),'hl',[0.1 0.95]);
